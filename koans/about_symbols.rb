...
class AboutSymbols < Neo::Koan
  ...
  #
  # See: https://stackoverflow.com/a/4686157
  #
  # "This is a bit of an odd one, because you have to test for the presence of
  # a symbol without accidentally creating that symbol during the test."
